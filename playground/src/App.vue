...
.app-container.min-h-screen.bg-base-300
  ...
  //- 内容
  main.flex.flex-col.items-center.gap-10

    .card.bg-base-100.shadow-xl.pt-4.p-8
      //-.card-body

      .flex.flex-col.gap-4(class="min-w-[20rem] md:min-w-[36rem]")
        .flex.items-center
          //- 选择模式用的标签页
          .tabs.flex-1
        ...
        //- 基本的设置
        .justify-center.gap-4(class="flex flex-col md:flex-row md:h-8")
